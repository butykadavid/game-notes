            ...
            <div className={styles.main__container}>
                ...
                <div className={styles.content__container}>
                    ...
                    <div className={styles.extras__wrapper}>
                        <div className={styles.get__started__box}>
                            <div className={styles.box__title__container}>
                                <h1 className={styles.box__title}>Get started</h1>
                            </div>
                            <div className={styles.row__container}>
                                ...
                                <a onClick={() => redirectToPage(router, `/dashboard`, { createReviewTitle: " " })} className={styles.row}>
                                    <div className={styles.icon}>
                                ...
                                <Link href={"/gaming-deals"} className={styles.row}>
                                    <div className={styles.icon}>
                                ...
                                <Link href={"/games"} className={styles.row}>
                                    <div className={styles.icon}>
